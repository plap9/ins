...
CREATE TABLE `media_edits` (
  ...
  `edit_data` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`edit_data`)),
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`edit_id`),
...
CREATE TABLE `notifications` (
  ...
  `user_id` bigint(20) NOT NULL,
  `type` enum('like','comment','follow','mention','message','story_view','story_reply','call','reel_comment','reel_like','reel_mention','close_friend_add','reel') NOT NULL,
